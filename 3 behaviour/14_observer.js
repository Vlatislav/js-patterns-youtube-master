...
есть некоторый объект один, у которого мы можем затригерить
вызов изменений и дальше, все другие объекты, которые подписаны
на эти изменения они получают эти обновления
*/
